...
void Renderer::UpdateWindowTitle(int scoreLeft, int scoreRight, int fps) {
  std::string title{"Left: " + std::to_string(scoreLeft) + " Right: " + std::to_string(scoreRight) + " FPS: " + std::to_string(fps)};
